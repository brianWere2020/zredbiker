...
<main>
	...
	<div class="clearfix">
		...
		<div class="wid-content">
		<select>
		<option vlaue"sdf" selected>Select month</option>
		<option vlaue"sdf" >july</option>
		<option vlaue"sdf" >august</option>
		<option vlaue"sdf">december</option>
		</select>
		</div>
		</div>
